...
'''
def custom_test_mqtt(ser=-1, msg_length=10, nbiot_connected = False, mqtt_connected = False):
...
'''
send_cmd("AT+QMTPUB=" + str(tcp_connect_id) + "," + str(msgID) + "," + str(qos) + "," + str(retain) + "," + "\"" + topic + "\"," + str(len(str_to_send)),ser,  custom_respons_end='>',print_response=print_response)
